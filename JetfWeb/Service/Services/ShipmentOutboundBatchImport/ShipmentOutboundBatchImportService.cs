    ...
    public class ShipmentOutboundBatchImportService : _BaseService
    {
            ...
            ShipmentInboundEntity entity)
        {
            ...
            return new FeeMasterCodEntity
            {
                ...
                OrderImporterId = entity.OrderImporterId,
                OrderImporter = entity.OrderImporter,
                OriginalImporterId = entity.OriginalImporterId,
                OriginalImporter = entity.OriginalImporter,
