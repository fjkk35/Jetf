mainApp.controller('ShipmentInboundReturnImportController', function ($scope, $http) {
    $scope.dataType = '';
    ...
    $scope.uploadFile = function () {
        var fileInput = document.getElementById('shipmentInboundReturnImportFileInput');
        ...
        formData.append('dataType', $scope.dataType);

        $.ajax({
            type: "POST",
            url: Router.action('ShipmentInboundReturnImport', 'Upload'),
            data: formData,
            cache: false,
            dataType: 'json',
            processData: false,
