...
interface DownloadNoIncludeTaxResponse {
    Redirect?: boolean;
    fileGuid?: string;
    fileName?: string;
    msg?: string;
...
interface DownloadNoIncludeTaxScope extends ng.IScope {
    form: {
        sDate: Date;
        eDate: Date;
        source: string;
...
mainApp.controller('DownloadNoIncludeTaxController', ['$scope', '$http', function (
    $scope: DownloadNoIncludeTaxScope,
    ...
    function createFormData(): FormData {
        ...
        var form = document.getElementById('DownloadNoIncludeTaxForm') as HTMLFormElement;
    ...
    function openDownloadFile(response: DownloadNoIncludeTaxResponse): void {
    ...
    $scope.download = function () {
        ...
        }).then(function (response: { data: DownloadNoIncludeTaxResponse }) {
