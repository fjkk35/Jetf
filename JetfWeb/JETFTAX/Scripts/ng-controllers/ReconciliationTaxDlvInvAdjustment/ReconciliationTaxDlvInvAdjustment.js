mainApp.controller('ReconciliationTaxDlvInvAdjustmentController', ['$scope', '$http', function ($scope, $http) {
        function getFileInput() {
            return document.getElementById('taxDlvInvAdjustmentFileInput');
        }
        ...
        $scope.uploadFile = function () {
            ...
            $scope.uploadSummary = null;
            $scope.uploadData = [];
            $http.post(Router.action('ReconciliationTaxDlvInvAdjustment', 'Upload'), formData, {
